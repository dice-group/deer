...
public class RandomSearchAlgorithm {
  ...
  public RandomSearchAlgorithm(Population startingPopulation, FitnessFunction fitnessFunction,
...
//    List<Resource> smell = history.get(history.size()-1).getBest().getSmell(true);
  ...
  private static boolean mustTerminate(int generation, Genotype bestInGeneration, int convergenceCounter) {
